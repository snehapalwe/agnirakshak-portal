...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Corresponding Values</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("corresponding_values/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-target_table"  value="<?php  echo $data['target_table']; ?>" type="text" placeholder="Enter Target Table"  required="" name="target_table"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-target_table_field_name"  value="<?php  echo $data['target_table_field_name']; ?>" type="text" placeholder="Enter Target Table Field Name"  required="" name="target_table_field_name"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-target_table_value_field"  value="<?php  echo $data['target_table_value_field']; ?>" type="text" placeholder="Enter Target Table Value Field"  required="" name="target_table_value_field"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-fetch_table"  value="<?php  echo $data['fetch_table']; ?>" type="text" placeholder="Enter Fetch Table"  required="" name="fetch_table"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-fetch_table_field_name"  value="<?php  echo $data['fetch_table_field_name']; ?>" type="text" placeholder="Enter Fetch Table Field Name"  required="" name="fetch_table_field_name"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
