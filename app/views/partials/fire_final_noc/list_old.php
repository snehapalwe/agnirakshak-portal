...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="grid" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Fire Final Noc / अंतिम फायर ना हरकत दाखला</h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                                    ...
                                    <div class="row sm-gutters page-data" id="page-data-<?php echo $page_element_id; ?>">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="bg-light p-2 mb-3 animated bounceIn">
                                                ...
                                                echo "<br>";
                                                    echo "<a href='" . SITE_ADDR . "fire_final_noc/revert/$id' class='btn btn-sm btn-danger'>Edit Application</a>";
                                                    echo "<br>";
                                                        echo "<br>";
                                                            }   
                                                            ?>
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if (!empty($data['upload_fixed_fire_fighting_installations_letter'])): ?>
                                                            <div class="mb-2" style="display: flex; justify-content: space-between; align-items: center;">
                                                                <strong style="font-weight: 500 !important; color: #000 !important;">
                                                                    Fixed Fire-Fighting Installations Letter:
                                                                </strong>  
                                                                <a href="<?php echo htmlspecialchars($data['upload_fixed_fire_fighting_installations_letter'], ENT_QUOTES, 'UTF-8'); ?>" 
                                                                    target="_blank" onclick="return autoPrintImage(this.href);"
                                                                    class="btn btn-info btn-sm">
                                                                    View Certificate
                                                                </a>
                                                            ...
                                                            <div class="mb-2" style="display: flex; justify-content: space-between; align-items: center;">
                                                                <strong style="font-weight: 500 !important; color: #000 !important;">
                                                                    Electric Contractor Certificate & License Copy:
                                                                </strong>  
                                                            ...
                                                            <div class="mb-2" style="display: flex; justify-content: space-between; align-items: center;">
                                                                <strong style="font-weight: 500 !important; color: #000 !important;">
                                                                    FORM-A Certificate From License Agency:
                                                                </strong>  
