...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Fire Final Noc</h4>
                </div>
                <div class="col-sm-3 ">
                </div>
                <div class="col-sm-4 ">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="fire_final_noc-mis_report-records">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-provisional_noc_number"> Provisional Noc Number</th>
                                                <th  class="td-revised_provisional_noc_number"> Revised Provisional Noc Number</th>
                                                ...
                                                <th  class="td-upload_provisional_fire_noc"> Upload Provisional Fire Noc</th>
                                                <th  class="td-upload_revised_provisional_fire_noc"> Upload Revised Provisional Fire Noc</th>
                                                <th  class="td-upload_fire_final_part_noc"> Upload Fire Final Part Noc</th>
                                                ...
                                                <th  class="td-upload_work_completion_certificate"> Upload Work Completion Certificate</th>
                                                <th  class="td-upload_structural_stability_certificate"> Upload Structural Stability Certificate</th>
                                                <th  class="td-upload_lift_certificate"> Upload Lift Certificate</th>
                                                <th  class="td-upload_fixed_fire_fighting_installations_letter"> Upload Fixed Fire Fighting Installations Letter</th>
                                                <th  class="td-upload_form_A_certificate_from_license_agency"> Upload Form A Certificate From License Agency</th>
                                                <th  class="td-upload_license_copy_of_MFS"> Upload License Copy Of Mfs</th>
                                                <th  class="td-upload_fire_auto_cad_drawing"> Upload Fire Auto Cad Drawing</th>
                                                <th  class="td-upload_affidavit"> Upload Affidavit</th>
                                                <th  class="td-upload_electric_contractor_certificate_and_license_copy"> Upload Electric Contractor Certificate And License Copy</th>
                                                <th  class="td-upload_diesel_engine_generator_invoice_copy_and_test_certificate"> Upload Diesel Engine Generator Invoice Copy And Test Certificate</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-provisional_noc_number"> <?php echo $data['provisional_noc_number']; ?></td>
                                                <td class="td-revised_provisional_noc_number"> <?php echo $data['revised_provisional_noc_number']; ?></td>
                                            ...
                                            <td class="td-upload_provisional_fire_noc"><?php Html :: page_link_file($data['upload_provisional_fire_noc']); ?></td>
                                            <td class="td-upload_revised_provisional_fire_noc"><?php Html :: page_link_file($data['upload_revised_provisional_fire_noc']); ?></td>
                                            <td class="td-upload_fire_final_part_noc"><?php Html :: page_link_file($data['upload_fire_final_part_noc']); ?></td>
                                            ...
                                            <td class="td-upload_work_completion_certificate"><?php Html :: page_link_file($data['upload_work_completion_certificate']); ?></td>
                                            <td class="td-upload_structural_stability_certificate"><?php Html :: page_link_file($data['upload_structural_stability_certificate']); ?></td>
                                            <td class="td-upload_lift_certificate"><?php Html :: page_link_file($data['upload_lift_certificate']); ?></td>
                                            <td class="td-upload_fixed_fire_fighting_installations_letter"><?php Html :: page_link_file($data['upload_fixed_fire_fighting_installations_letter']); ?></td>
                                            <td class="td-upload_form_A_certificate_from_license_agency"><?php Html :: page_link_file($data['upload_form_A_certificate_from_license_agency']); ?></td>
                                            <td class="td-upload_license_copy_of_MFS"><?php Html :: page_link_file($data['upload_license_copy_of_MFS']); ?></td>
                                            <td class="td-upload_fire_auto_cad_drawing"><?php Html :: page_link_file($data['upload_fire_auto_cad_drawing']); ?></td>
                                            <td class="td-upload_affidavit"><?php Html :: page_link_file($data['upload_affidavit']); ?></td>
                                            <td class="td-upload_electric_contractor_certificate_and_license_copy"><?php Html :: page_link_file($data['upload_electric_contractor_certificate_and_license_copy']); ?></td>
                                            <td class="td-upload_diesel_engine_generator_invoice_copy_and_test_certificate"><?php Html :: page_link_file($data['upload_diesel_engine_generator_invoice_copy_and_test_certificate']); ?></td>
