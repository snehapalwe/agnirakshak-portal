                        ...
                        <form id="fire_final_noc-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("fire_final_noc/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <label class="control-label" for="do_you_want_to_apply_with_full_potential_plan">DO YOU WANT TO APPLY WITH FULL POTENTIAL PLAN? <span class="text-danger">*</span></label>
                                    <div id="ctrl-do_you_want_to_apply_with_full_potential_plan-holder" class=""> 
                                        <select required=""  id="ctrl-do_you_want_to_apply_with_full_potential_plan" name="do_you_want_to_apply_with_full_potential_plan"  placeholder="Select a value ..."    class="custom-select" >
                                            <option value="">Select a value ...</option>
                                            <?php
                                            $do_you_want_to_apply_with_full_potential_plan_options = Menu :: $is_redevelopment;
                                            if(!empty($do_you_want_to_apply_with_full_potential_plan_options)){
                                            foreach($do_you_want_to_apply_with_full_potential_plan_options as $option){
                                            $value = $option['value'];
                                            $label = $option['label'];
                                            $selected = $this->set_field_selected('do_you_want_to_apply_with_full_potential_plan', $value, "");
                                            ?>
                                ...
                                <div class="form-group ">
                                    <label class="control-label" for="upload_the_full_potential_plan">UPLOAD THE FULL POTENTIAL PLAN <span class='text-danger'>*</span> </label>
                                    <div id="ctrl-upload_the_full_potential_plan-holder" class=""> 
                                        <div class="dropzone " input="#ctrl-upload_the_full_potential_plan" fieldname="upload_the_full_potential_plan"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.jpeg,.pdf" filesize="3" maximum="1">
                                            <input name="upload_the_full_potential_plan" id="ctrl-upload_the_full_potential_plan" class="dropzone-input form-control" value="<?php  echo $this->set_field_value('upload_the_full_potential_plan',""); ?>" type="text"  />
                                                                                                                ...
                                                                                                                <div class="form-group ">
                                                                                                                    ...
                                                                                                                    <div class="form-group ">
                                                                                                                        ...
                                                                                                                        <div class="form-group ">
                                                                                                                            ...
                                                                                                                            <div class="form-group ">
                                                                                                                                <label class="control-label" for="upload_electric_contractor_certificate_and_license_copy">UPLOAD ELECTRIC CONTRACT AUDIT REPORT & LICENSE COPY <span class="text-danger">*</span></label>
                                                                                                                                ...
                                                                                                                                <div class="form-group ">
                                                                                                                                    ...
                                                                                                                                    <div class="form-group ">
                                                                                                                                        <label class="control-label" for="upload_form_A_certificate_from_license_agency">UPLOAD FORM-A WITH FIRE PUMP'S CERTIFICATE FROM LICENSE AGENCY <span class="text-danger">*</span></label>
                                                                                                                                        ...
                                                                                                                                        <div class="form-group ">
                                                                                                                                            <label class="control-label" for="upload_license_copy_of_MFS">UPLOAD LICENSE COPY OF MAHARASHTRA FIRE SERVICE (MFS) <span class="text-danger">*</span></label>
                                                                                                                                        ...
                                                                                                                                        <div class="form-group ">
                                                                                                                                            <label class="control-label" for="upload_fire_resistance_door">UPLOAD FIRE RESISTANCE DOOR <span class="text-danger">*</span></label>
                                                                                                                                            <div id="ctrl-upload_fire_resistance_door-holder" class=""> 
                                                                                                                                                <div class="dropzone required" input="#ctrl-upload_fire_resistance_door" fieldname="upload_license_copy_of_MFS"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="3" maximum="1">
                                                                                                                                                    <input name="upload_fire_resistance_door" id="ctrl-upload_fire_resistance_door" required="" class="dropzone-input form-control" value="<?php  echo $this->set_field_value('upload_fire_resistance_door',""); ?>" type="text"  />
                                                                                                                                                        <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                                                                                                        <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                                <small class="form-text"><p style="color: red; font-size: 12px;">इमारतीच्या वापरानुसार अग्निरोधक दरवाजे बसवणे बंधनकारक आहे<br>Upload file size should not exceed 3 MB.</p></small>
                                                                                                                                            </div> 
                                                                                                                                        <div class="form-group ">
                                                                                                                                            <label class="control-label" for="upload_firefighting_specs_basements_or_terraces_and_water_tank_c">UPLOAD FIREFIGHTING SPECS (BASEMENTS/TERRACES) & WATER TANK CERTIFICATE <span class="text-danger">*</span></label>
                                                                                                                                            <div id="ctrl-upload_firefighting_specs_basements_or_terraces_and_water_tank_c-holder" class=""> 
                                                                                                                                                <div class="dropzone required" input="#ctrl-upload_firefighting_specs_basements_or_terraces_and_water_tank_c" fieldname="upload_license_copy_of_MFS"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="3" maximum="1">
                                                                                                                                                    <input name="upload_firefighting_specs_basements_or_terraces_and_water_tank_c" id="ctrl-upload_firefighting_specs_basements_or_terraces_and_water_tank_c" required="" class="dropzone-input form-control" value="<?php  echo $this->set_field_value('upload_firefighting_specs_basements_or_terraces_and_water_tank_c',""); ?>" type="text"  />
                                                                                                                                                        <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                                                                                                        <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                        ...
                                                                                                                                        <div class="col-md-12 comp-grid">
                                                                                                                                            <div class=""><div></div>
                                                                                                                                                <script>
                                                                                                                                                    ...
                                                                                                                                                    $.getJSON("<?php echo SITE_ADDR ?>api/get_form_filled/"+ctrlVal+"/fire_noc_provisional_new",function(data){
                                                                                                                                                    ...
                                                                                                                                                    alert("Pls ensure that number is correct");
                                                                                                                                                    $(this).val("");
                                                                                                                                                    }
                                                                                                                                                    });
                                                                                                                                                    });
                                                                                                                                                    ...
                                                                                                                                                    if(isset($rec['id'])){
                                                                                                                                                    ?>
                                                                                                                                                    $('#ctrl-provisional_noc_number').val("<?php echo $rec['application_no']; ?>");
                                                                                                                                                    $('#ctrl-provisional_noc_number').prop("readonly",true);
                                                                                                                                                   
    setTimeout(function() { $('#ctrl-provisional_noc_number').trigger("change"); });
                                                                                                                                                    <?php
                                                                                                                                                    }
                                                                                                                                                    ?>
                                                                                                                                                </script></div>
...
const TABLE_NAME = "fire_final_noc";
