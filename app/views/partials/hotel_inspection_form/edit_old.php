...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Hotel Inspection Edit  / हॉटेल पाहणी बदल</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("hotel_inspection_form/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <input id="ctrl-recid"  value="<?php  echo $data['recid']; ?>" type="hidden" placeholder="Enter Recid"  required="" name="recid"  class="form-control " />
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-hotel_name"  value="<?php  echo $data['hotel_name']; ?>" type="text" placeholder="Enter Hotel Name"  required="" name="hotel_name"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-hotel_address"  value="<?php  echo $data['hotel_address']; ?>" type="text" placeholder="Enter Hotel Address"  required="" name="hotel_address"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <input id="ctrl-building_floor"  value="<?php  echo $data['building_floor']; ?>" type="text" placeholder="Enter Building Floor"  required="" name="building_floor"  class="form-control " />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <input id="ctrl-no_n_width_stairs_one"  value="<?php  echo $data['no_n_width_stairs_one']; ?>" type="text" placeholder="Enter No. & Width Stairs One"  required="" name="no_n_width_stairs_one"  class="form-control " />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group ">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <div class="">
                                                                                        <input id="ctrl-no_n_width_stairs_two"  value="<?php  echo $data['no_n_width_stairs_two']; ?>" type="text" placeholder="Enter No. & Width Stairs Two"  required="" name="no_n_width_stairs_two"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group ">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-8">
                                                                                        <div class="">
                                                                                            <input id="ctrl-no_n_width_stairs_three"  value="<?php  echo $data['no_n_width_stairs_three']; ?>" type="text" placeholder="Enter No. & Width Stairs Three"  required="" name="no_n_width_stairs_three"  class="form-control " />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group ">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-8">
                                                                                            <div class="">
                                                                                                <input id="ctrl-no_lifts_in_the_building"  value="<?php  echo $data['no_lifts_in_the_building']; ?>" type="text" placeholder="Enter No. & Lifts In The Building"  required="" name="no_lifts_in_the_building"  class="form-control " />
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group ">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-sm-8">
                                                                                                <div class="">
                                                                                                    <input id="ctrl-no_entrance_routes"  value="<?php  echo $data['no_entrance_routes']; ?>" type="text" placeholder="Enter No. of Entrance Routes"  required="" name="no_entrance_routes"  class="form-control " />
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group ">
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-sm-8">
                                                                                                    <div class="">
                                                                                                        <input id="ctrl-no_exit_routes"  value="<?php  echo $data['no_exit_routes']; ?>" type="text" placeholder="Enter No. of Exit Routes"  required="" name="no_exit_routes"  class="form-control " />
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                                    ...
                                                                                                    <div class="col-sm-8">
                                                                                                        <div class="">
                                                                                                            <select required=""  id="ctrl-store_room_id" name="store_room_id"  placeholder="Select a value ..."    class="custom-select" >
                                                                                                                ...
                                                                                                                $field_value = $data['store_room_id'];
                                                                                            ...
                                                                                            <div class="form-group ">
                                                                                                <div class="row">
                                                                                                    ...
                                                                                                    <div class="col-sm-8">
                                                                                                        <div class="">
                                                                                                            <input id="ctrl-natural_ventilation_windows"  value="<?php  echo $data['natural_ventilation_windows']; ?>" type="text" placeholder="Enter Number of Natural Ventilation Windows"  required="" name="natural_ventilation_windows"  class="form-control " />
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="form-group ">
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <div class="col-sm-8">
                                                                                                            <div class="">
                                                                                                                <input id="ctrl-area"  value="<?php  echo $data['area']; ?>" type="text" placeholder="Enter Area (Sq. Mtr)"  required="" name="area"  class="form-control " />
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div class="form-group ">
                                                                                                        <div class="row">
                                                                                                            ...
                                                                                                            <div class="col-sm-8">
                                                                                                                <div class="">
                                                                                                                    <input id="ctrl-no_employees_female"  value="<?php  echo $data['no_employees_female']; ?>" type="number" placeholder="Enter No. of Female Employees " step="1"  required="" name="no_employees_female"  class="form-control " />
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="form-group ">
                                                                                                            <div class="row">
                                                                                                                ...
                                                                                                                <div class="col-sm-8">
                                                                                                                    <div class="">
                                                                                                                        <input id="ctrl-no_employees_male"  value="<?php  echo $data['no_employees_male']; ?>" type="number" placeholder="Enter No. of Male Employees " step="1"  required="" name="no_employees_male"  class="form-control " />
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <div class="form-group ">
                                                                                                                <div class="row">
                                                                                                                    ...
                                                                                                                    <div class="col-sm-8">
                                                                                                                        <div class="">
                                                                                                                            <input id="ctrl-no_employees_total"  value="<?php  echo $data['no_employees_total']; ?>" type="number" placeholder="Enter No. of Total Employees " step="1"  required="" name="no_employees_total"  class="form-control " />
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div class="form-group ">
                                                                                                                    <div class="row">
                                                                                                                        ...
                                                                                                                        <div class="col-sm-8">
                                                                                                                            <div class="">
                                                                                                                                <input id="ctrl-working_hours"  value="<?php  echo $data['working_hours']; ?>" type="text" placeholder="Enter Working Hours"  required="" name="working_hours"  class="form-control " />
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                    <div class="form-group ">
                                                                                                                        <div class="row">
                                                                                                                            ...
                                                                                                                            <div class="col-sm-8">
                                                                                                                                <div class="">
                                                                                                                                    <input id="ctrl-floor_number_of_hotel"  value="<?php  echo $data['floor_number_of_hotel']; ?>" type="text" placeholder="Enter Floor Number Of Hotel"  required="" name="floor_number_of_hotel"  class="form-control " />
                                                                                                                                    </div>
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                                ...
                                                                                                                                <div class="col-sm-8">
                                                                                                                                    <div class="">
                                                                                                                                        <select required=""  id="ctrl-is_directional_board_available" name="is_directional_board_available"  placeholder="Select a value ..."    class="custom-select" >
                                                                                                                                            ...
                                                                                                                                            $field_value = $data['is_directional_board_available'];
                                                                                                                        ...
                                                                                                                        <div class="form-group ">
                                                                                                                            <div class="row">
                                                                                                                                ...
                                                                                                                                <div class="col-sm-8">
                                                                                                                                    <div class="">
                                                                                                                                        <input id="ctrl-hotel_departments"  value="<?php  echo $data['hotel_departments']; ?>" type="text" placeholder="Enter Hotel Departments"  required="" name="hotel_departments"  class="form-control " />
                                                                                                                                        </div>
                                                                                                                                    </div>
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                                            <div class="form-group ">
                                                                                                                                <div class="row">
                                                                                                                                    ...
                                                                                                                                    <div class="col-sm-8">
                                                                                                                                        <div class="">
                                                                                                                                            <input id="ctrl-table_quantity"  value="<?php  echo $data['table_quantity']; ?>" type="number" placeholder="Enter Table Quantity" step="1"  required="" name="table_quantity"  class="form-control " />
                                                                                                                                            </div>
                                                                                                                                        </div>
                                                                                                                                    </div>
                                                                                                                                </div>
                                                                                                                                <div class="form-group ">
                                                                                                                                    <div class="row">
                                                                                                                                        ...
                                                                                                                                        <div class="col-sm-8">
                                                                                                                                            <div class="">
                                                                                                                                                <input id="ctrl-chair_quantity"  value="<?php  echo $data['chair_quantity']; ?>" type="number" placeholder="Enter Chair Quantity" step="1"  required="" name="chair_quantity"  class="form-control " />
                                                                                                                                                </div>
                                                                                                                                            </div>
                                                                                                                                        </div>
                                                                                                                                    </div>
                                                                                                                                            ...
                                                                                                                                            <div class="col-sm-8">
                                                                                                                                                <div class="">
                                                                                                                                                    <select required=""  id="ctrl-is_generator_system_available" name="is_generator_system_available"  placeholder="Select a value ..."    class="custom-select" >
                                                                                                                                                        ...
                                                                                                                                                        $field_value = $data['is_generator_system_available'];
                                                                                                                                            ...
                                                                                                                                            <div class="col-sm-8">
                                                                                                                                                <div class="">
                                                                                                                                                    <select required=""  id="ctrl-is_structural_audit_report_avilable_id" name="is_structural_audit_report_avilable_id"  placeholder="Select a value ..."    class="custom-select" >
                                                                                                                                                        <option value="">Select a value ...</option>
                                                                                                                                                        <?php
                                                                                                                                                        $rec = $data['is_structural_audit_report_avilable_id'];
                                                                                                                                                ...
                                                                                                                                                <div class="col-sm-8">
                                                                                                                                                    <div class="">
                                                                                                                                                        <select required=""  id="ctrl-is_electrical_audit_report_available_id" name="is_electrical_audit_report_available_id"  placeholder="Select a value ..."    class="custom-select" >
                                                                                                                                                            <option value="">Select a value ...</option>
                                                                                                                                                            <?php
                                                                                                                                                            $rec = $data['is_electrical_audit_report_available_id'];
                                                                                                                                        ...
                                                                                                                                        <div class="form-group ">
                                                                                                                                            ...
                                                                                                                                            <div class="form-group ">
                                                                                                                                                <div class="row">
                                                                                                                                                    ...
                                                                                                                                                    <div class="col-sm-8">
                                                                                                                                                        <div class="">
                                                                                                                                                            <input id="ctrl-fire_prevention_measures_information"  value="<?php  echo $data['fire_prevention_measures_information']; ?>" type="text" placeholder="Enter Fire Prevention Measures Information"  required="" name="fire_prevention_measures_information"  class="form-control " />
                                                                                                                                                            </div>
                                                                                                                                                        </div>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                                <div class="form-group ">
                                                                                                                                                    <div class="row">
                                                                                                                                                        ...
                                                                                                                                                        <div class="col-sm-8">
                                                                                                                                                            <div class="">
                                                                                                                                                                <input id="ctrl-extinguishing_licen_agency_name"  value="<?php  echo $data['extinguishing_licen_agency_name']; ?>" type="text" placeholder="Enter Extinguishing Licen Agency Name"  required="" name="extinguishing_licen_agency_name"  class="form-control " />
                                                                                                                                                                </div>
                                                                                                                                                            </div>
                                                                                                                                                        </div>
                                                                                                                                                    </div>
                                                                                                                                                    <div class="form-group ">
                                                                                                                                                        <div class="row">
                                                                                                                                                            ...
                                                                                                                                                            <div class="col-sm-8">
                                                                                                                                                                <div class="">
                                                                                                                                                                    <input id="ctrl-extinguishing_licen_agency_no"  value="<?php  echo $data['extinguishing_licen_agency_no']; ?>" type="text" placeholder="Enter Extinguishing Licen Agency No"  required="" name="extinguishing_licen_agency_no"  class="form-control " />
                                                                                                                                                                    </div>
                                                                                                                                                                </div>
                                                                                                                                                            </div>
                                                                                                                                                        </div>
                                                                                                                                                        <div class="form-group ">
                                                                                                                                                            <div class="row">
                                                                                                                                                                ...
                                                                                                                                                                <div class="col-sm-8">
                                                                                                                                                                    <div class="">
                                                                                                                                                                        <input id="ctrl-extinguishing_licen_agency_validity"  value="<?php  echo $data['extinguishing_licen_agency_validity']; ?>" type="text" placeholder="Enter Extinguishing Licen Agency Validity"  required="" name="extinguishing_licen_agency_validity"  class="form-control " />
                                                                                                                                                                        </div>
                                                                                                                                                                    </div>
                                                                                                                                                                </div>
                                                                                                                                                            </div>
                                                                                                                                                            <div class="form-group ">
                                                                                                                                                                ...
                                                                                                                                                                <div class="form-group ">
                                                                                                                                                                    <div class="row">
                                                                                                                                                                        ...
                                                                                                                                                                        <div class="col-sm-8">
                                                                                                                                                                            <div class="">
                                                                                                                                                                                <input id="ctrl-water_storage_capacity_terrace"  value="<?php  echo $data['water_storage_capacity_terrace']; ?>" type="number" placeholder="Enter Water Storage Capacity Terrace (Ltr) " step="1"  required="" name="water_storage_capacity_terrace"  class="form-control " />
                                                                                                                                                                                </div>
                                                                                                                                                                            </div>
                                                                                                                                                                        </div>
                                                                                                                                                                    </div>
                                                                                                                                                                    <div class="form-group ">
                                                                                                                                                                        <div class="row">
                                                                                                                                                                            ...
                                                                                                                                                                            <div class="col-sm-8">
                                                                                                                                                                                <div class="">
                                                                                                                                                                                    <input id="ctrl-water_storage_capacity_groundfloor"  value="<?php  echo $data['water_storage_capacity_groundfloor']; ?>" type="number" placeholder="Enter Water Storage Capacity Groundfloor (Ltr) " step="1"  required="" name="water_storage_capacity_groundfloor"  class="form-control " />
                                                                                                                                                                                    </div>
                                                                                                                                                                                </div>
                                                                                                                                                                            </div>
                                                                                                                                                                        </div>
                                                                                                                                                                        <div class="form-group ">
                                                                                                                                                                            <div class="row">
                                                                                                                                                                                ...
                                                                                                                                                                                <div class="col-sm-8">
                                                                                                                                                                                    <div class="">
                                                                                                                                                                                        <input id="ctrl-gas_bank"  value="<?php  echo $data['gas_bank']; ?>" type="text" placeholder="Enter Gas Bank"  required="" name="gas_bank"  class="form-control " />
                                                                                                                                                                                        </div>
                                                                                                                                                                                    </div>
                                                                                                                                                                                </div>
                                                                                                                                                                            </div>
                                                                                                                                                                            <div class="form-group ">
                                                                                                                                                                                <div class="row">
                                                                                                                                                                                    ...
                                                                                                                                                                                    <div class="col-sm-8">
                                                                                                                                                                                        <div class="">
                                                                                                                                                                                            <input id="ctrl-lpg_cylender"  value="<?php  echo $data['lpg_cylender']; ?>" type="text" placeholder="Enter Lpg Cylender"  required="" name="lpg_cylender"  class="form-control " />
                                                                                                                                                                                            </div>
                                                                                                                                                                                        </div>
                                                                                                                                                                                    </div>
                                                                                                                                                                                </div>
                                                                                                                                                                                <div class="form-group ">
                                                                                                                                                                                    <div class="row">
                                                                                                                                                                                        ...
                                                                                                                                                                                        <div class="col-sm-8">
                                                                                                                                                                                            <div class="">
                                                                                                                                                                                                <input id="ctrl-cng_pipe_line"  value="<?php  echo $data['cng_pipe_line']; ?>" type="text" placeholder="Enter Cng Pipe Line"  required="" name="cng_pipe_line"  class="form-control " />
                                                                                                                                                                                                </div>
                                                                                                                                                                                            </div>
                                                                                                                                                                                        </div>
                                                                                                                                                                                    </div>
