...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><strong style='color: black;'>Renewal of Fire Final Noc / अंतिम फायर ना हरकत दाखला नुतनीकरण</strong></h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="fire_final_noc_renewal-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("fire_final_noc_renewal/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <label class="control-label" for="old_final_fire_noc_number">OLD FINAL FIRE NOC NUMBER  <span class="text-danger">*</span></label>
                                    <div id="ctrl-old_final_fire_noc_number-holder" class=""> 
                                        <input id="ctrl-old_final_fire_noc_number"  value="<?php  echo $this->set_field_value('old_final_fire_noc_number',""); ?>" type="text" placeholder="Enter Old Final Fire Noc Number"  required="" name="old_final_fire_noc_number"  class="form-control " />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                                                                                ...
                                                                                                <div class="form-group ">
                                                                                                    ...
                                                                                                    <div id="ctrl-upload_last_year_final_fire_noc-holder" class=""> 
                                                                                                        <div class="dropzone required" input="#ctrl-upload_last_year_final_fire_noc" fieldname="upload_last_year_final_fire_noc"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="3" maximum="1">
                                                                                                            <input name="upload_last_year_final_fire_noc" id="ctrl-upload_last_year_final_fire_noc" required="" class="dropzone-input form-control" value="<?php  echo $this->set_field_value('upload_last_year_final_fire_noc',""); ?>" type="text"  />
