    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                ...
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("other_establishment_inspection_form/add") ?>">
                ...
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('other_establishment_inspection_form'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('other_establishment_inspection_form'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="other_establishment_inspection_form-list-records">
                                <?php
                                if(!empty($records)){
                                ?>
                                    ...
                                    <div class="row sm-gutters page-data" id="page-data-<?php echo $page_element_id; ?>">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="bg-light p-2 mb-3 animated bounceIn">
                                                ...
                                                <div class="mb-2">  
                                                    <span class="font-weight-light text-muted ">
                                                        Type Of Application ID :  
                                                    </span>
                                                <?php echo $data['type_of_application_id']; ?></div>
                                                <div class="mb-2">  
                                                    <span class="font-weight-light text-muted ">
                                                        TYPE OF APPLICATION :  
                                                    </span>
                                                ...
                                                <div class="mb-2">  <?php Html :: page_link_file($data['permissions_obtained_for_the_business']); ?></div>
                                                <div class="mb-2">  
                                                    <span class="font-weight-light text-muted ">
                                                ...
                                                <div class="mb-2">  
                                                    <span class="font-weight-light text-muted ">
                                                        MPCB CERTIFICATE DATE :  
                                                    </span>
                                                <?php echo $data['mpcb_certificate_date']; ?></div>
                                                <div class="mb-2">  
                                                    <span class="font-weight-light text-muted ">
                                                        MPCB CERTIFICATE VALIDITY DATE :  
                                                    </span>
                                                <?php echo $data['mpcb_certificate_validity_date']; ?></div>
                                                <div class="mb-2">  
                                                    <span class="font-weight-light text-muted ">
                                                        AC AMC DATE :  
                                                    </span>
                                                <?php echo $data['ac_amc_date']; ?></div>
                                                <div class="mb-2">  
                                                    <span class="font-weight-light text-muted ">
                                                        AC AMC VALIDITY DATE :  
                                                    </span>
                                                <?php echo $data['ac_amc_validity_date']; ?></div>
                                                <div class="mb-2">  
                                                    <span class="font-weight-light text-muted ">
                                                        AC AMC AGENCY NAME :  
                                                    </span>
                                                <?php echo $data['ac_amc_agency_name']; ?></div>
                                                <div class="mb-2">  
                                                    <span class="font-weight-light text-muted ">
                                                        AC AMC AGENCY ADDRESS :  
                                                    </span>
                                                <?php echo $data['ac_amc_agency_address']; ?></div>
                                                <div class="mb-2">  
                                                    <span class="font-weight-light text-muted ">
                                                        AC AMC AGENCY CONTACT :  
                                                    </span>
                                                <?php echo $data['ac_amc_agency_contact']; ?></div>
                                                <div class="mb-2">  
                                                    <span class="font-weight-light text-muted ">
                                                        DIRECTION BOARD :  
                                                    </span>
                                                <?php echo $data['direction_board']; ?></div>
                                                <div class="mb-2">  
                                                    <span class="font-weight-light text-muted ">
                                                        User ID :  
                                                    </span>
                                                ...
                                                <?php echo $data['certificate_file']; ?></div>
                                                <div class="mb-2">  
                                                    <span class="font-weight-light text-muted ">
                                                        TIMESTAMP :  
                                                    </span>
                                                ...
                                                <div class="td-btn">
                                                    <?php if($can_view){ ?>
                                                    <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link("other_establishment_inspection_form/view/$rec_id"); ?>">
                                                        <i class="fa fa-eye"></i> View
                                                    </a>
                                                    <?php } ?>
                                                    <?php if($can_edit){ ?>
                                                    <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("other_establishment_inspection_form/edit/$rec_id"); ?>">
