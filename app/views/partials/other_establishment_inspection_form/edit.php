...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Other Establishment Inspection  Edit / इतर आस्थापनांकरिता  पाहणी बदल</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("other_establishment_inspection_form/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <select required=""  id="ctrl-type_of_application_id" name="type_of_application_id"  placeholder="Select a value ..."    class="custom-select" >
                                                                                ...
                                                                                $type_of_application_id_options = $comp_model -> other_establishment_inspection_form_type_of_application_id_option_list();
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <select required=""  id="ctrl-building_type" name="building_type"  placeholder="Select a value ..."    class="custom-select" >
                                                                                        ...
                                                                                        $building_type_options = $comp_model -> other_establishment_inspection_form_building_type_option_list();
