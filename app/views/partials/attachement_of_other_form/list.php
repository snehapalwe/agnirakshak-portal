    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                ...
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("attachement_of_other_form/add") ?>">
                        <i class="fa fa-plus"></i>                              
                        Add New Attachement Of Other Form / इतर जोडलेले फॉर्म 
                    </a>
                    <?php } ?>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('attachement_of_other_form'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('attachement_of_other_form'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="attachement_of_other_form-list-records">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-service_db"> Service Db / सेवा डिबी </th>
                                                <th  class="td-other_form_db"> Other Form Db / इतर फॉर्म डिबी </th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-id"><a href="<?php print_link("attachement_of_other_form/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                                <td class="td-service_db">
