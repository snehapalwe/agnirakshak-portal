                        ...
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("fire_noc_provisional_new/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div id="ctrl-do_you_want_to_apply_with_full_potential_plan-holder" class=""> </div></div>
                                                                                    <div class="col-sm-8">
                                        <select required=""  id="ctrl-do_you_want_to_apply_with_full_potential_plan" name="do_you_want_to_apply_with_full_potential_plan"  placeholder="Select a value ..."    class="custom-select" >
                                            ...
                                            $value = $option['value'];
                                            $label = $option['label'];
                                            $selected = $value==$data['do_you_want_to_apply_with_full_potential_plan']?"selected":"";
                                            ?>
                                                                                    ...
                                                                                    <div class="col-sm-8">
                                                                                        <div class="">
                                                                                            <div class="dropzone " input="#ctrl-upload_the_full_potential_plan" fieldname="upload_the_full_potential_plan"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.jpeg,.pdf" filesize="3" maximum="1">
                                                                                                <input name="upload_the_full_potential_plan" id="ctrl-upload_the_full_potential_plan"  ="" class="dropzone-input form-control" value="<?php  echo $data['upload_the_full_potential_plan']; ?>" type="text"  />
                                                                                                    <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                                                    <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                                                </div>
                                                                                            </div>
                                                                                            <?php Html :: uploaded_files_list($data['upload_the_full_potential_plan'], '#ctrl-upload_the_full_potential_plan'); ?>
