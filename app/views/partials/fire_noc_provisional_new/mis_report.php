...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Fire Noc Provisional New</h4>
                </div>
                <div class="col-sm-3 ">
                </div>
                <div class="col-sm-4 ">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        <form method="get" action="<?php print_link($current_page) ?>" class="form filter-form">
                            <div class="card mb-3">
                                <div class="card-header h4 h4">Filter by Fire Noc Provisional New Timestamp</div>
                                <div class="p-2">
                                    <input class="form-control datepicker"  value="<?php echo $this->set_field_value('fire_noc_provisional_new_timestamp') ?>" type="datetime"  name="fire_noc_provisional_new_timestamp" placeholder="" data-enable-time="" data-date-format="Y-m-d" data-alt-format="M j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                    </div>
                                </div>
                                <hr />
                    ...
                    <div class="row ">
                        <div class="col-md-12 comp-grid">
                            ...
                            <div  class=" animated fadeIn page-content">
                                <div id="fire_noc_provisional_new-mis_report-records">
                                        ...
                                        <table class="table  table-striped table-sm text-left">
                                            <thead class="table-header bg-light">
                                                <tr>
                                                    ...
                                                    <th  class="td-uplaod_architect_application_with_building_plans"> Uplaod Architect Application With Building Plans</th>
                                                    <th  class="td-upload_layout_of_fire_prevention_and_protection_measures"> Upload Layout Of Fire Prevention And Protection Measures</th>
                                                    <th  class="td-is_redevelopment"> Is Redevelopment</th>
                                                    <th  class="td-upload_society_consent_or_recommendation_letter"> Upload Society Consent Or Recommendation Letter</th>
                                                    <th  class="td-upload_dbr_report"> Upload Dbr Report</th>
                                                    <th class="td-btn"></th>
                                                </tr>
                                            </thead>
                                            <?php
                                            ...
                                            <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-status"> <span><?php
                                                        ...
                                                        // echo "<a href='".$data['admin_report']."' class='btn btn-success'>Download Administrative 
                                                            }
                                                            }
                                                            }
                                                            else{
                                                    ...
                                                    <td class="td-uplaod_architect_application_with_building_plans"> <?php echo $data['uplaod_architect_application_with_building_plans']; ?></td>
                                                    <td class="td-upload_layout_of_fire_prevention_and_protection_measures"> <?php echo $data['upload_layout_of_fire_prevention_and_protection_measures']; ?></td>
                                                    <td class="td-is_redevelopment"> <?php echo $data['is_redevelopment']; ?></td>
                                                    <td class="td-upload_society_consent_or_recommendation_letter"> <?php echo $data['upload_society_consent_or_recommendation_letter']; ?></td>
                                                    <td class="td-upload_dbr_report"> <?php echo $data['upload_dbr_report']; ?></td>
                                                </tr>
                                                <?php 
                                                }
                                                ?>
