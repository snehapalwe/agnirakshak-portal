...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="grid" data-page-url="<?php print_link($current_page); ?>">
 ...
 echo "<br>";
        ...
        if(USER_ROLE == 3){
                                                                    ...
                                                                    if($status=="Completed"&&$data['upload_noc']==""){
                                                                        
                                                                    echo "<span style='font-weight: bold; background-color: $bgColor; color: $textColor; padding: 2px 5px; color: black;'>PENDING AT AUTH 3</span><br>";
                                                                    }else{ 
                                                                        
                                                                    if(!$citizen_pay){
                                                                    echo "<span style='font-weight: bold; background-color: $bgColor; color: $textColor; padding: 2px 5px;  ;'>$status</span><br>";
                                                                    }
                                                                    }
                                                                        }
