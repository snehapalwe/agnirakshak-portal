...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Floor Details</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="floor_details-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("floor_details/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <label class="control-label" for="typical_floor_plan">TYPICAL FLOOR PLAN  </label>
                                    <div id="ctrl-typical_floor_plan-holder" class=""> 
                                        <select  id="ctrl-typical_floor_plan" name="typical_floor_plan"  placeholder="Select a value ..."    class="custom-select" >
                                            <option value="">Select a value ...</option>
                                            <?php 
                                            $typical_floor_plan_options = $comp_model -> floor_details_typical_floor_plan_option_list();
                                            if(!empty($typical_floor_plan_options)){
                                            foreach($typical_floor_plan_options as $option){
                                            $value = (!empty($option['value']) ? $option['value'] : null);
                                            $label = (!empty($option['label']) ? $option['label'] : $value);
                                            $selected = $this->set_field_selected('typical_floor_plan',$value, "");
                                            ?>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div id="ctrl-floor_type-holder" class=""> 
                                        <select required=""  id="ctrl-floor_type" name="floor_type"  placeholder="Select a value ..."    class="custom-select" >
                                            <option value="">Select a value ...</option>
                                            <?php 
                                            $floor_type_options = $comp_model -> floor_details_floor_type_option_list();
                                ...
                                <div class="form-group ">
                                    <label class="control-label" for="foor_name_id">Floor Name Id <span class="text-danger">*</span></label>
                                    <div id="ctrl-foor_name_id-holder" class=""> 
                                        <select required=""  id="ctrl-foor_name_id" name="foor_name_id"  placeholder="Select a value ..."    class="custom-select" >
                                            <option value="">Select a value ...</option>
                                            <?php 
                                            $foor_name_id_options = $comp_model -> floor_details_foor_name_id_option_list();
                                ...
                                <input id="ctrl-recid"  value="<?php  echo $this->set_field_value('recid',""); ?>" type="hidden" placeholder="Enter Recid"  required="" name="recid"  class="form-control " />
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <label class="control-label" for="hight_in_mtr_from_ground">Height In Mtr From Ground <span class="text-danger">*</span></label>
                                            <div id="ctrl-hight_in_mtr_from_ground-holder" class=""> 
                                                <input id="ctrl-hight_in_mtr_from_ground"  value="<?php  echo $this->set_field_value('hight_in_mtr_from_ground',""); ?>" type="number" placeholder="Enter Height In Mtr From Ground" step="any"  required="" name="hight_in_mtr_from_ground"  class="form-control " />
                                                </div>
                                            </div>
                                            <input id="ctrl-db_name"  value="<?php  echo $this->set_field_value('db_name',""); ?>" type="hidden" placeholder="Enter Db Name"  required="" name="db_name"  class="form-control " />
                                                <div class="form-group ">
                                                    <label class="control-label" for="hight_of_refuge_area_from_ground_in_mtr">Height  Of Refuge Area From Ground In Mtr  <span class='text-danger'>*</span> </label>
