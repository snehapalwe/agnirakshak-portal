...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title" style="color:black; font-weight: bold;">ADD SURVEY VISIT DETAILS</h4>
                </div>
            </div>
        </div>
    </div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div id="ctrl-survey_photos-holder" class=""> 
                                                        <div class="dropzone required" input="#ctrl-survey_photos" fieldname="survey_photos"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="30" maximum="<?php echo $_GET['db_name']=='fire_noc_provisional_new'?5:25 ?>">
