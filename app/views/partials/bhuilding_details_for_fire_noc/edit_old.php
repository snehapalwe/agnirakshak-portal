...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Building Details For Fire Noc</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("bhuilding_details_for_fire_noc/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <input id="ctrl-db_name"  value="<?php  echo $data['db_name']; ?>" type="hidden" placeholder="Enter Db Name"  readonly required="" name="db_name"  class="form-control " />
                                    <input id="ctrl-recid"  value="<?php  echo $data['recid']; ?>" type="hidden" placeholder="Enter Recid"  readonly required="" name="recid"  class="form-control " />
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-name_of_building"  value="<?php  echo $data['name_of_building']; ?>" type="text" placeholder="Enter Name Of Building"  required="" name="name_of_building"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <select required=""  id="ctrl-do_you_have_wing" name="do_you_have_wing"  placeholder="Select a value ..."    class="custom-select" >
                                                                ...
                                                                $field_value = $data['do_you_have_wing'];
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-height_of_building_in_mtr"  value="<?php  echo $data['height_of_building_in_mtr']; ?>" type="number" placeholder="Enter Height Of Building In Mtr" step="0.1"  required="" name="height_of_building_in_mtr"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-number_of_staircase"  value="<?php  echo $data['number_of_staircase']; ?>" type="number" placeholder="Enter Number Of Staircase" step="1"  required="" name="number_of_staircase"  class="form-control " />
                                                                </div>
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-number_of_lifts"  value="<?php  echo $data['number_of_lifts']; ?>" type="number" placeholder="Enter Number Of Lifts" step="1"  required="" name="number_of_lifts"  class="form-control " />
                                                                    </div>
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-location_count_of_refuge_area"  value="<?php  echo $data['location_count_of_refuge_area']; ?>" type="number" placeholder="Enter Location Count Of Refuge Area" step="1"  required="" name="location_count_of_refuge_area"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
