...
$can_add = ACL::is_allowed("fire_noc_provisional/add");
$can_edit = ACL::is_allowed("fire_noc_provisional/edit");
$can_view = ACL::is_allowed("fire_noc_provisional/view");
$can_delete = ACL::is_allowed("fire_noc_provisional/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Fire Noc Provisional</h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("fire_noc_provisional/add") ?>">
                        <i class="fa fa-plus"></i>                              
                        Add New Fire Noc Provisional 
                    </a>
                    <?php } ?>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('fire_noc_provisional'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('fire_noc_provisional'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="fire_noc_provisional-list-records">
                                    ...
                                    <table class="table  table-striped table-sm text-center table-bordered">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-upload_developers_letter"> Upload Developers Letter</th>
                                                ...
                                                <th  class="td-upload_location_site_photos"> Upload Location Site Photos</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-upload_developers_letter"><?php Html :: page_link_file($data['upload_developers_letter']); ?></td>
                                                ...
                                                <td class="td-upload_location_site_photos"><?php Html :: page_link_file($data['upload_location_site_photos']); ?></td>
