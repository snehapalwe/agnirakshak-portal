...
$can_add = ACL::is_allowed("fire_noc_revised_provisional/add");
$can_edit = ACL::is_allowed("fire_noc_revised_provisional/edit");
$can_view = ACL::is_allowed("fire_noc_revised_provisional/view");
$can_delete = ACL::is_allowed("fire_noc_revised_provisional/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Fire Noc Revised Provisional</h4>
                </div>
                <div class="col-sm-3 ">
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('fire_noc_revised_provisional/'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('fire_noc_revised_provisional'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        <form method="get" action="<?php print_link($current_page) ?>" class="form filter-form">
                            <div class="card mb-3">
                                <div class="card-header h4 h4">Filter by Fire Noc Revised Provisional Timestamp</div>
                                <div class="p-2">
                                    <input class="form-control datepicker"  value="<?php echo $this->set_field_value('fire_noc_revised_provisional_timestamp') ?>" type="datetime"  name="fire_noc_revised_provisional_timestamp" placeholder="" data-enable-time="" data-date-format="Y-m-d" data-alt-format="M j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                    </div>
                                </div>
                                <hr />
                    ...
                    <div class="row ">
                        <div class="col-md-12 comp-grid">
                            ...
                            <div  class=" animated fadeIn page-content">
                                <div id="fire_noc_revised_provisional-mis_report-records">
                                        ...
                                        <table class="table  table-striped table-sm text-left">
                                            <thead class="table-header bg-light">
                                                <tr>
                                                    ...
                                                    <th  class="td-change_of_usage"> Change Of Usage</th>
                                                    <th  class="td-upload_change_of_usage_certificate"> Upload Change Of Usage Certificate</th>
                                                    <th  class="td-upload_old_provisional_receipt_copy"> Upload Old Provisional Receipt Copy</th>
                                                    <th  class="td-upload_hardship_letter"> Upload Hardship Letter</th>
                                            ...
                                            <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                                ...
                                                <td class="td-change_of_usage"> <?php echo $data['change_of_usage']; ?></td>
                                                <td class="td-upload_change_of_usage_certificate"><?php Html :: page_link_file($data['upload_change_of_usage_certificate']); ?></td>
                                                <td class="td-upload_old_provisional_receipt_copy"><?php Html :: page_link_file($data['upload_old_provisional_receipt_copy']); ?></td>
                                                <td class="td-upload_hardship_letter"><?php Html :: page_link_file($data['upload_hardship_letter']); ?></td>
