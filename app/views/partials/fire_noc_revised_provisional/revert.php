...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Fire Noc Revised Provisional</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("fire_noc_revised_provisional/revert/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div id="ctrl-change_of_usage-holder" class=""> 
                                                                        <select required=""  id="ctrl-change_of_usage" name="change_of_usage"  placeholder="Select a value ..."    class="custom-select" >
                                                                            ...
                                                                            $field_value = $data['change_of_usage'];
                                                                ...
                                                                <div class="form-group ">
                                                                    <label class="control-label" for="upload_change_of_usage_certificate">Upload Change Of Usage Certificate </label>
                                                                    <div id="ctrl-upload_change_of_usage_certificate-holder" class=""> 
                                                                        <div class="dropzone " input="#ctrl-upload_change_of_usage_certificate" fieldname="upload_change_of_usage_certificate"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="3" maximum="1">
                                                                            <input name="upload_change_of_usage_certificate" id="ctrl-upload_change_of_usage_certificate" class="dropzone-input form-control" value="<?php  echo $data['upload_change_of_usage_certificate']; ?>" type="text"  />
                                                                                <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                                <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                            </div>
                                                                        </div>
                                                                        <?php Html :: uploaded_files_list($data['upload_change_of_usage_certificate'], '#ctrl-upload_change_of_usage_certificate'); ?>
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div id="ctrl-upload_old_provisional_receipt_copy-holder" class=""> 
                                                                        <div class="dropzone required" input="#ctrl-upload_old_provisional_receipt_copy" fieldname="upload_old_provisional_receipt_copy"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="3" maximum="1">
                                                                            <input name="upload_old_provisional_receipt_copy" id="ctrl-upload_old_provisional_receipt_copy" required="" class="dropzone-input form-control" value="<?php  echo $data['upload_old_provisional_receipt_copy']; ?>" type="text"  />
                                                                                <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                                <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                            </div>
                                                                        </div>
                                                                        <?php Html :: uploaded_files_list($data['upload_old_provisional_receipt_copy'], '#ctrl-upload_old_provisional_receipt_copy'); ?>
                                                                        <small class="form-text"><p style="color: red; font-size: 12px;">Upload file size should not exceed 3 MB.</p></small>
                                                                    </div>
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div id="ctrl-upload_hardship_letter-holder" class=""> 
                                                                            <div class="dropzone " input="#ctrl-upload_hardship_letter" fieldname="upload_hardship_letter"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="3" maximum="1">
                                                                                <input name="upload_hardship_letter" id="ctrl-upload_hardship_letter" class="dropzone-input form-control" value="<?php  echo $data['upload_hardship_letter']; ?>" type="text"  />
                                                                                    <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                                    <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                                </div>
                                                                            </div>
                                                                            <?php Html :: uploaded_files_list($data['upload_hardship_letter'], '#ctrl-upload_hardship_letter'); ?>
                                                                            <small class="form-text"><p style="font-size: 12px;">
                                                                                <span style="color: green; font-weight: bold;">(Optional)</span>
                                                                                <span style="color: red;"> Upload file size should not exceed 3 MB.</span>
                                                                            </p>
