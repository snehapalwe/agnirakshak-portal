...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="grid" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><strong style='color: black;'>REVISED PROVISIONAL FIRE NOC</strong>
                    </h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("fire_noc_revised_provisional/add") ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="fire_noc_revised_provisional-list-records">
                                <?php
                                if(!empty($records)){
                                ?>
                                    ...
                                    <div class="row sm-gutters page-data" id="page-data-<?php echo $page_element_id; ?>">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="bg-light p-2 mb-3 animated bounceIn">
                                                ...
                                                echo "<br>";
                                                    echo "<a href='" . SITE_ADDR . "fire_noc_revised_provisional/revert/$id' class='btn btn-sm btn-danger'>Edit Application</a>";
                                                    echo "<br>";
                                                        echo "<br>";
                                                            }   
                                                            ?>
                                                            ...
                                                            <?php echo $data['change_of_usage']; ?></div>
                                                            <?php if (!empty($data['upload_change_of_usage_certificate'])): ?>
                                                            <div class="mb-2">
                                                                <strong style="font-weight: 500 !important; color: #000 !important;">
                                                                    Change of Usage Certificate:
                                                                </strong>  
                                                                <a href="<?php echo htmlspecialchars($data['upload_change_of_usage_certificate'], ENT_QUOTES, 'UTF-8'); ?>" 
                                                                    target="_blank" 
                                                            ...
                                                            <div class="mb-2 mt-1">
                                                                ...
                                                                <a href="<?php echo SITE_ADDR . "fire_noc_revised_provisional/edit_zone/" . $data['id']; ?>" 
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if (!empty($data['upload_old_provisional_receipt_copy'])): ?>
                                                            <div class="mb-2" style="display: flex; justify-content: space-between; align-items: center;">
                                                                <strong style="font-weight: 500 !important; color: #000 !important;">
                                                                    Old Provisional Receipt Copy:
                                                                </strong>  
                                                                <a href="<?php echo htmlspecialchars($data['upload_old_provisional_receipt_copy'], ENT_QUOTES, 'UTF-8'); ?>" 
                                                                    target="_blank" onclick="return autoPrintImage(this.href);"
                                                                    class="btn btn-info btn-sm">
                                                                    View Document
                                                                </a>
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if (!empty($data['upload_hardship_letter'])): ?>
                                                            <div class="mb-2" style="display: flex; justify-content: space-between; align-items: center;">
                                                                <strong style="font-weight: 500 !important; color: #000 !important;">
                                                                    Hardship Letter:
                                                                </strong>  
                                                                <a href="<?php echo htmlspecialchars($data['upload_hardship_letter'], ENT_QUOTES, 'UTF-8'); ?>" 
                                                                    target="_blank" onclick="return autoPrintImage(this.href);"
                                                                    class="btn btn-info btn-sm">
                                                                    View Letter
                                                                </a>
                                                                                                    ...
                                                                                                    echo "<br>";
                                                                                                        ...
                                                                                                        echo "<br>";
                                                                                                            echo "<br>";
                                                                                                                ...
                                                                                                                // Show the amount demanded if it exists
                                                                                                                if(!empty($data['amount'])){
                                                                                                                echo "<p class='text-muted'>Demanded Amount: ₹".htmlspecialchars($data['amount'])."</p>";
                                                                                                                }
