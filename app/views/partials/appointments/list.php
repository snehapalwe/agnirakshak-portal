    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                ...
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("appointments/add") ?>">
                        <i class="fa fa-plus"></i>                              
                        Add New Appointments / अपॉइंटमेंट्स 
                    </a>
                    <?php } ?>
                </div>
                <div class="col-sm-4 ">
                                    ...
                                    <table class="table  table-striped table-sm text-center table-bordered">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-admin_id"> Admin Id / प्रशासक आयडी</th>
                                                <th  class="td-date"> Date / तारीख</th>
                                                <th  class="td-time"> Time / वेळ</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-id"><a href="<?php print_link("appointments/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                                <td class="td-db_name">
