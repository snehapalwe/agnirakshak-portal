...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Appointment / अपॉइंटमेंट</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="appointments-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("appointments/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div id="ctrl-db_name-holder" class=""> 
                                        <input id="ctrl-db_name"  value="<?php  echo $this->set_field_value('db_name',""); ?>" type="text" placeholder="Enter Db Name / डेटाबेस नाव"  required="" name="db_name"  class="form-control " />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-rec_id-holder" class=""> 
                                            <input id="ctrl-rec_id"  value="<?php  echo $this->set_field_value('rec_id',""); ?>" type="text" placeholder="Enter Rec Id / रेकॉर्ड आयडी"  required="" name="rec_id"  class="form-control " />
                                            </div>
                                        </div>
                                        <div class="form-group ">
