                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-userid_added"  value="<?php  echo $data['userid_added']; ?>" type="number" placeholder="Enter Userid Added" step="1"  required="" name="userid_added"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-rec_id"  value="<?php  echo $data['rec_id']; ?>" type="text" placeholder="Enter Rec Id"  required="" name="rec_id"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-txn_no"  value="<?php  echo $data['txn_no']; ?>" type="text" placeholder="Enter Txn No"  required="" name="txn_no"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <input id="ctrl-citizen_userid"  value="<?php  echo $data['citizen_userid']; ?>" type="text" placeholder="Enter Citizen Userid"  required="" name="citizen_userid"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div class="form-group ">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <div class="">
                                                                                        <input id="ctrl-rec_no"  value="<?php  echo $data['rec_no']; ?>" type="text" placeholder="Enter Rec No"  required="" name="rec_no"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group ">
                                                                                ...
                                                                                <div class="form-group ">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-8">
                                                                                            <div class="">
                                                                                                <input id="ctrl-payment_type"  value="<?php  echo $data['payment_type']; ?>" type="text" placeholder="Enter Payment Type"  required="" name="payment_type"  class="form-control " />
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="form-group ">
                                                                                            ...
                                                                                            <div class="form-group ">
                                                                                                <div class="row">
                                                                                                    ...
                                                                                                    <div class="col-sm-8">
                                                                                                        <div class="">
                                                                                                            <input id="ctrl-payment_bankname"  value="<?php  echo $data['payment_bankname']; ?>" type="text" placeholder="Enter Payment Bankname"  required="" name="payment_bankname"  class="form-control " />
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="form-group ">
                                                                                                    ...
                                                                                                    <div class="form-group ">
                                                                                                        <div class="row">
                                                                                                            ...
                                                                                                            <div class="col-sm-8">
                                                                                                                <div class="">
                                                                                                                    <input id="ctrl-payment_counter"  value="<?php  echo $data['payment_counter']; ?>" type="text" placeholder="Enter Payment Counter"  required="" name="payment_counter"  class="form-control " />
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="form-group ">
                                                                                                            <div class="row">
                                                                                                                ...
                                                                                                                <div class="col-sm-8">
                                                                                                                    <div class="">
                                                                                                                        <input id="ctrl-paid_by"  value="<?php  echo $data['paid_by']; ?>" type="text" placeholder="Enter Paid By"  required="" name="paid_by"  class="form-control " />
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
