...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="grid" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><strong style='color: black;'>Fire Final Part NOC</strong>
                    </h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("fire_final_part_noc/add") ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="fire_final_part_noc-list-records">
                                <?php
                                if(!empty($records)){
                                ?>
                                    ...
                                    <div class="row sm-gutters page-data" id="page-data-<?php echo $page_element_id; ?>">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="bg-light p-2 mb-3 animated bounceIn">
                                                ...
                                                echo "<br>";
                                                    echo "<a href='" . SITE_ADDR . "fire_final_part_noc/edit/$id' class='btn btn-sm btn-danger'>Edit Application</a>";
                                                    echo "<br>";
                                                        echo "<br>";
                                                            }   
                                                            ?>
                                                            ...
                                                            <div class="mb-2">  
                                                                <span class="font-weight-light text-muted ">
                                                                    Is Provisional Fire NOC Taken:  
                                                                </span>
                                                            <?php echo $data['is_revised_provisional_taken']; ?></div>
                                                            <?php if (!empty($data['provisional_noc_number'])): ?>
                                                            <div class="mb-2">
                                                                <strong style="font-weight: 500 !important; color: #000 !important;">
                                                                    Provisional NOC Number:
                                                                </strong>  
                                                            ...
                                                            <div class="mb-2">  
                                                                <span class="font-weight-light text-muted ">
                                                                    Is Revised Provisional Fire Noc Taken:  
                                                                </span>
                                                            <?php echo $data['is_revised_noc_taken']; ?></div>
                                                            <?php if (!empty($data['revised_provisional_noc_number'])): ?>
                                                            <div class="mb-2">
                                                                <strong style="font-weight: 500 !important; color: #000 !important;">
                                                                    Revised Provisional NOC Number:
                                                                </strong>  
                                                                <span style="font-weight: bold;">
                                                            ...
                                                            <div class="mb-2 mt-1">
                                                                ...
                                                                <a href="<?php echo SITE_ADDR . "fire_final_part_noc/edit_zone/" . $data['id']; ?>" 
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if (!empty($data['upload_form_a'])): ?>
                                                            <div class="mb-2" style="display: flex; justify-content: space-between; align-items: center;">
                                                                <strong style="font-weight: 500 !important; color: #000 !important;">
                                                                    UPLOAD FORM A :
                                                                </strong>  
                                                                <a href="<?php echo htmlspecialchars($data['upload_form_a'], ENT_QUOTES, 'UTF-8'); ?>" 
                                                                    target="_blank" onclick="return autoPrintImage(this.href);"
                                                                    class="btn btn-info btn-sm">
                                                                    Form A
                                                                </a>
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if (!empty($data['upload_lic_of_mfs'])): ?>
                                                            <div class="mb-2" style="display: flex; justify-content: space-between; align-items: center;">
                                                                <strong style="font-weight: 500 !important; color: #000 !important;">
                                                                    Upload License Copy Of MFS:
                                                                </strong>  
                                                                <a href="<?php echo htmlspecialchars($data['upload_lic_of_mfs'], ENT_QUOTES, 'UTF-8'); ?>" 
                                                                    target="_blank"
                                                                    class="btn btn-info btn-sm">
                                                                    License Copy Of MFS
                                                                </a>
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if (!empty($data['upload_electric_contract'])): ?>
                                                            <div class="mb-2" style="display: flex; justify-content: space-between; align-items: center;">
                                                                <strong style="font-weight: 500 !important; color: #000 !important;">
                                                                    Electric Contractor Certificate :
                                                                </strong>  
                                                                <a href="<?php echo htmlspecialchars($data['upload_electric_contract'], ENT_QUOTES, 'UTF-8'); ?>" 
                                                                    target="_blank"
                                                                    class="btn btn-info btn-sm">
                                                                    Electric Contractor Certificate 
                                                                </a>
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if (!empty($data['upload_site_photo'])): ?>
                                                            <div class="mb-2" style="display: flex; justify-content: space-between; align-items: center;">
                                                                <strong style="font-weight: 500 !important; color: #000 !important;">
                                                                    Upload Site Photo :
                                                                </strong>  
                                                                <a href="<?php echo htmlspecialchars($data['upload_site_photo'], ENT_QUOTES, 'UTF-8'); ?>" 
                                                                    target="_blank"
                                                                    class="btn btn-info btn-sm">
                                                                    Site Upload
                                                                </a>
                                                                                                                    ...
                                                                                                                    echo "<br>";
                                                                                                                        ...
                                                                                                                        echo "<br>";
                                                                                                                            echo "<br>";
                                                                                                                                ...
                                                                                                                                echo '<br><span style="font-weight: bold; background-color: yellow; padding: 2px 5px; border-radius: 3px;">Pending at Citizen End for Payment</span><br>';
                                                                                                                                    }else{
                                                                                                                                    echo "<a href='".SITE_ADDR."accept_reject/add?db_name=".$_SESSION['tablename']."&rec_id=".$data['id']."' class='btn btn-sm btn-danger'>Accept/Reject</a>";
                                                                                                                                    echo "<br>";
                                                                                                                                        echo "<br>";
