...
$can_add = ACL::is_allowed("fire_final_part_noc/add");
$can_edit = ACL::is_allowed("fire_final_part_noc/edit");
$can_view = ACL::is_allowed("fire_final_part_noc/view");
$can_delete = ACL::is_allowed("fire_final_part_noc/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Fire Final Part Noc</h4>
                </div>
                <div class="col-sm-3 ">
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('fire_final_part_noc/'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('fire_final_part_noc'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        <form method="get" action="<?php print_link($current_page) ?>" class="form filter-form">
                            <div class="card mb-3">
                                <div class="card-header h4 h4">Filter by Fire Final Part Noc Timestamp</div>
                                <div class="p-2">
                                    <input class="form-control datepicker"  value="<?php echo $this->set_field_value('fire_final_part_noc_timestamp') ?>" type="datetime"  name="fire_final_part_noc_timestamp" placeholder="" data-enable-time="" data-date-format="Y-m-d" data-alt-format="M j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                    </div>
                                </div>
                                <hr />
                    ...
                    <div class="row ">
                        <div class="col-md-12 comp-grid">
                            ...
                            <div  class=" animated fadeIn page-content">
                                <div id="fire_final_part_noc-mis_report-records">
                                        ...
                                        <table class="table  table-striped table-sm text-left">
                                            <thead class="table-header bg-light">
                                                <tr>
                                                    ...
                                                    <th  class="td-is_revised_noc_taken"> Is Revised Noc Taken</th>
                                                    <th  class="td-is_revised_provisional_taken"> Is Revised Provisional Taken</th>
                                                    ...
                                                    <th  class="td-upload_form_a"> Upload Form A</th>
                                                    <th  class="td-upload_lic_of_mfs"> Upload Lic Of Mfs</th>
                                                    <th  class="td-upload_electric_contract"> Upload Electric Contract</th>
                                                    <th  class="td-upload_site_photo"> Upload Site Photo</th>
                                            ...
                                            <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                                ...
                                                <td class="td-upload_noc"><a href="<?php print_link("fire_final_part_noc/view/$data[id]") ?>"><?php echo $data['upload_noc']; ?></a></td>
                                                <td class="td-admin_report"><?php Html :: page_link_file($data['admin_report']); ?></td>
                                                <td class="td-is_revised_noc_taken"> <?php echo $data['is_revised_noc_taken']; ?></td>
                                                <td class="td-is_revised_provisional_taken"> <?php echo $data['is_revised_provisional_taken']; ?></td>
                                                ...
                                                <td class="td-upload_form_a"><?php Html :: page_link_file($data['upload_form_a']); ?></td>
                                                <td class="td-upload_lic_of_mfs"><?php Html :: page_link_file($data['upload_lic_of_mfs']); ?></td>
                                                <td class="td-upload_electric_contract"><?php Html :: page_link_file($data['upload_electric_contract']); ?></td>
                                                <td class="td-upload_site_photo"><?php Html :: page_link_file($data['upload_site_photo']); ?></td>
