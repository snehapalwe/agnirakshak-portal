...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Fire Final Part NOC Edit / फायर फायनल पार्ट ना हरकत दाखला बदल</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("fire_final_part_noc/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-is_revised_provisional_taken" name="is_revised_provisional_taken"  placeholder="Select a value ..."    class="custom-select" >
                                                    ...
                                                    $field_value = $data['is_revised_provisional_taken'];
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-provisional_noc_number"  value="<?php  echo $data['provisional_noc_number']; ?>" type="text" placeholder="Enter Provisional Noc Number "  name="provisional_noc_number"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-is_revised_noc_taken" name="is_revised_noc_taken"  placeholder="Select a value ..."    class="custom-select" >
                                                        ...
                                                        $field_value = $data['is_revised_noc_taken'];
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-revised_provisional_noc_number"  value="<?php  echo $data['revised_provisional_noc_number']; ?>" type="text" placeholder="Enter Revised Provisional Noc Number "  name="revised_provisional_noc_number"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
