...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Marraige Demand / विवाह मागणी</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("marraige_demand/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-to_date-holder" class="input-group"> 
                                            <input id="ctrl-to_date" class="form-control datepicker  datepicker" required="" value="<?php  echo $data['to_date']; ?>" type="datetime"  name="to_date" placeholder="Enter To Date / या तारखेपर्यंत" data-enable-time="true" data-min-date="" data-max-date="" data-date-format="Y-m-d H:i:S" data-alt-format="F j, Y - H:i" data-inline="false" data-no-calendar="false" data-mode="single" /> 
                                                <div class="input-group-append">
                                                    <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div id="ctrl-amount-holder" class=""> 
                                                <input id="ctrl-amount"  value="<?php  echo $data['amount']; ?>" type="text" placeholder="Enter Amount / रक्कम"  required="" name="amount"  class="form-control " />
                                                </div>
                                            </div>
                                            <div class="form-group ">
