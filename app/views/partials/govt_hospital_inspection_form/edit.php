...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Government Hospital Inspection Edit / शासकीय हॉस्पिटल पाहणी बदल</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("govt_hospital_inspection_form/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                                                                                    ...
                                                                                                    <div class="col-sm-8">
                                                                                                        <div class="">
                                                                                                            <select required=""  id="ctrl-is_record_room_available" name="is_record_room_available"  placeholder="Select a value ..."    class="custom-select" >
                                                                                                                ...
                                                                                                                $field_value = $data['is_record_room_available'];
                                                                                                                        ...
                                                                                                                        <div class="form-group ">
                                                                                                                            ...
                                                                                                                            <div class="form-group ">
                                                                                                                                <div class="row">
                                                                                                                                    ...
                                                                                                                                    <div class="col-sm-8">
                                                                                                                                        <div class="">
                                                                                                                                            <input id="ctrl-floor_number_of_hospital_value"  value="<?php  echo $data['floor_number_of_hospital_value']; ?>" type="text" placeholder="Enter Floor Number Of Hospital Value"  required="" name="floor_number_of_hospital_value"  class="form-control " />
                                                                                                                                            </div>
                                                                                                                                        </div>
                                                                                                                                    </div>
                                                                                                                                </div>
