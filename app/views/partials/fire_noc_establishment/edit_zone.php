            ...
            <div class="row ">
                <div class="col-md-6 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("fire_noc_establishment/edit_zone/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
