                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-payment-holder" class=""> 
                                            <select required=""  id="ctrl-payment" name="payment"  placeholder="Select a value ..."    class="custom-select" >
                                                ...
                                                $value = $option['value'];
                                                $label = $option['label'];
                                                $selected = $this->set_field_selected('payment', $value, "");
                                                ?>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-rate-holder" class=""> 
                                            <input id="ctrl-rate"  value="<?php  echo $this->set_field_value('rate',""); ?>" type="number" placeholder="Enter Rate" step="0.01"  name="rate"  class="form-control " />
                                            </div>
                                        </div>
                                        <div class="form-group ">
