...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Mall or Cinema Hall Inspection Edit / मॅाल, सिनेमा गृह   पाहणी बदल</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("mall_cinema_inspection_form/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-owners_mobile_number"  value="<?php  echo $data['owners_mobile_number']; ?>" type="number" placeholder="Enter Owners Mobile Number" step="1"  required="" name="owners_mobile_number"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <select required=""  id="ctrl-type_of_application_id" name="type_of_application_id"  placeholder="Select a value ..."    class="custom-select" >
                                                                                ...
                                                                                $type_of_application_id_options = $comp_model -> mall_cinema_inspection_form_type_of_application_id_option_list();
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <select required=""  id="ctrl-building_type" name="building_type"  placeholder="Select a value ..."    class="custom-select" >
                                                                                        ...
                                                                                        $building_type_options = $comp_model -> mall_cinema_inspection_form_building_type_option_list();
                                                                                                    ...
                                                                                                    <div class="form-group ">
                                                                                                        ...
                                                                                                        <div class="form-group ">
                                                                                                            <div class="row">
                                                                                                                ...
                                                                                                                <div class="col-sm-8">
                                                                                                                    <div class="">
                                                                                                                        <div class="dropzone required" input="#ctrl-permissions_obtained_for_the_business" fieldname="permissions_obtained_for_the_business"    data-multiple="true" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="10" maximum="5">
                                                                                                                            <input name="permissions_obtained_for_the_business" id="ctrl-permissions_obtained_for_the_business" required="" class="dropzone-input form-control" value="<?php  echo $data['permissions_obtained_for_the_business']; ?>" type="text"  />
                                                                                                                                <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                                                                                <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                        <?php Html :: uploaded_files_list($data['permissions_obtained_for_the_business'], '#ctrl-permissions_obtained_for_the_business'); ?>
                                                                                                                        <small class="form-text">Upload All permissions</small>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <div class="form-group ">
                                                                                                                    ...
                                                                                                                    <div class="form-group ">
                                                                                                                        ...
                                                                                                                        <div class="form-group ">
                                                                                                                            ...
                                                                                                                            <div class="form-group ">
                                                                                                                                <div class="row">
                                                                                                                                    <div class="col-sm-4">
                                                                                                                                        <label class="control-label" for="natural_ventilation_total_windows">TOTAL WINDOWS (VENTILATION)  <span class="text-danger">*</span></label>
                                                                                                                                    </div>
                                                                                                                                    <div class="col-sm-8">
                                                                                                                                        <div class="">
                                                                                                                                            <input id="ctrl-natural_ventilation_total_windows"  value="<?php  echo $data['natural_ventilation_total_windows']; ?>" type="number" placeholder="Enter Natural Ventilation Total Windows" step="1"  required="" name="natural_ventilation_total_windows"  class="form-control " />
                                                                                                                                            </div>
                                                                                                                                        </div>
                                                                                                                                    </div>
                                                                                                                                </div>
                                                                                                                                <div class="form-group ">
                                                                                                                                    <div class="row">
                                                                                                                                        <div class="col-sm-4">
                                                                                                                                            <label class="control-label" for="natural_ventilation_total_doors">TOTAL DOORS (VENTILATION)  <span class="text-danger">*</span></label>
                                                                                                                                        </div>
                                                                                                                                        <div class="col-sm-8">
                                                                                                                                            <div class="">
                                                                                                                                                <input id="ctrl-natural_ventilation_total_doors"  value="<?php  echo $data['natural_ventilation_total_doors']; ?>" type="number" placeholder="Enter Natural Ventilation Total Doors" step="1"  required="" name="natural_ventilation_total_doors"  class="form-control " />
                                                                                                                                                </div>
                                                                                                                                            </div>
                                                                                                                                        </div>
                                                                                                                                    </div>
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                <div class="form-group ">
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    <div class="form-group ">
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        <div class="form-group ">
                                                                                                                                                                                                                                            <div class="row">
                                                                                                                                                                                                                                                <div class="col-sm-4">
                                                                                                                                                                                                                                                    <label class="control-label" for="mpcb_certificate_date">MPCB CERTIFICATE DATE  <span class="text-danger">*</span></label>
                                                                                                                                                                                                                                                </div>
                                                                                                                                                                                                                                                <div class="col-sm-8">
                                                                                                                                                                                                                                                    <div class="input-group">
                                                                                                                                                                                                                                                        <input id="ctrl-mpcb_certificate_date" class="form-control datepicker  datepicker"  required="" value="<?php  echo $data['mpcb_certificate_date']; ?>" type="datetime" name="mpcb_certificate_date" placeholder="Enter Mpcb Certificate Date" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                                                                                                                                                                                                                                            <div class="input-group-append">
                                                                                                                                                                                                                                                                <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                                                                                                                                                                                                                            </div>
                                                                                                                                                                                                                                                        </div>
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            <div class="form-group ">
                                                                                                                                                                                                                                                <div class="row">
                                                                                                                                                                                                                                                    <div class="col-sm-4">
                                                                                                                                                                                                                                                        <label class="control-label" for="mpcb_certificate_validity_date">MPCB CERTIFICATE VALIDITY DATE  <span class="text-danger">*</span></label>
                                                                                                                                                                                                                                                    </div>
                                                                                                                                                                                                                                                    <div class="col-sm-8">
                                                                                                                                                                                                                                                        <div class="input-group">
                                                                                                                                                                                                                                                            <input id="ctrl-mpcb_certificate_validity_date" class="form-control datepicker  datepicker"  required="" value="<?php  echo $data['mpcb_certificate_validity_date']; ?>" type="datetime" name="mpcb_certificate_validity_date" placeholder="Enter Mpcb Certificate Validity Date" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                                                                                                                                                                                                                                                <div class="input-group-append">
                                                                                                                                                                                                                                                                    <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                                                                                                                                                                                                                                </div>
                                                                                                                                                                                                                                                            </div>
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <div class="form-group ">
                                                                                                                                                                                                                                                    <div class="row">
                                                                                                                                                                                                                                                        <div class="col-sm-4">
                                                                                                                                                                                                                                                            <label class="control-label" for="ac_amc_date">AC AMC DATE  <span class="text-danger">*</span></label>
                                                                                                                                                                                                                                                        </div>
                                                                                                                                                                                                                                                        <div class="col-sm-8">
                                                                                                                                                                                                                                                            <div class="input-group">
                                                                                                                                                                                                                                                                <input id="ctrl-ac_amc_date" class="form-control datepicker  datepicker"  required="" value="<?php  echo $data['ac_amc_date']; ?>" type="datetime" name="ac_amc_date" placeholder="Enter Ac Amc Date" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                                                                                                                                                                                                                                                    <div class="input-group-append">
                                                                                                                                                                                                                                                                        <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                                                                                                                                                                                                                                    </div>
                                                                                                                                                                                                                                                                </div>
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    <div class="form-group ">
                                                                                                                                                                                                                                                        <div class="row">
                                                                                                                                                                                                                                                            <div class="col-sm-4">
                                                                                                                                                                                                                                                                <label class="control-label" for="ac_amc_validity_date">AC AMC VALIDITY DATE  <span class="text-danger">*</span></label>
                                                                                                                                                                                                                                                            </div>
                                                                                                                                                                                                                                                            <div class="col-sm-8">
                                                                                                                                                                                                                                                                <div class="input-group">
                                                                                                                                                                                                                                                                    <input id="ctrl-ac_amc_validity_date" class="form-control datepicker  datepicker"  required="" value="<?php  echo $data['ac_amc_validity_date']; ?>" type="datetime" name="ac_amc_validity_date" placeholder="Enter Ac Amc Validity Date" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                                                                                                                                                                                                                                                        <div class="input-group-append">
                                                                                                                                                                                                                                                                            <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                                                                                                                                                                                                                                        </div>
                                                                                                                                                                                                                                                                    </div>
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        <div class="form-group ">
                                                                                                                                                                                                                                                            <div class="row">
                                                                                                                                                                                                                                                                <div class="col-sm-4">
                                                                                                                                                                                                                                                                    <label class="control-label" for="ac_amc_agency_name">AC AMC AGENCY NAME  <span class="text-danger">*</span></label>
                                                                                                                                                                                                                                                                </div>
                                                                                                                                                                                                                                                                <div class="col-sm-8">
                                                                                                                                                                                                                                                                    <div class="">
                                                                                                                                                                                                                                                                        <input id="ctrl-ac_amc_agency_name"  value="<?php  echo $data['ac_amc_agency_name']; ?>" type="text" placeholder="Enter Ac Amc Agency Name"  required="" name="ac_amc_agency_name"  class="form-control " />
                                                                                                                                                                                                                                                                        </div>
                                                                                                                                                                                                                                                                    </div>
                                                                                                                                                                                                                                                                </div>
                                                                                                                                                                                                                                                            </div>
                                                                                                                                                                                                                                                            <div class="form-group ">
                                                                                                                                                                                                                                                                <div class="row">
                                                                                                                                                                                                                                                                    <div class="col-sm-4">
                                                                                                                                                                                                                                                                        <label class="control-label" for="ac_amc_agency_address">AC AMC AGENCY ADDRESS  <span class="text-danger">*</span></label>
                                                                                                                                                                                                                                                                    </div>
                                                                                                                                                                                                                                                                    <div class="col-sm-8">
                                                                                                                                                                                                                                                                        <div class="">
                                                                                                                                                                                                                                                                            <input id="ctrl-ac_amc_agency_address"  value="<?php  echo $data['ac_amc_agency_address']; ?>" type="text" placeholder="Enter Ac Amc Agency Address"  required="" name="ac_amc_agency_address"  class="form-control " />
                                                                                                                                                                                                                                                                            </div>
                                                                                                                                                                                                                                                                        </div>
                                                                                                                                                                                                                                                                    </div>
                                                                                                                                                                                                                                                                </div>
                                                                                                                                                                                                                                                                <div class="form-group ">
                                                                                                                                                                                                                                                                    <div class="row">
                                                                                                                                                                                                                                                                        <div class="col-sm-4">
                                                                                                                                                                                                                                                                            <label class="control-label" for="ac_amc_agency_contact">AC AMC AGENCY CONTACT  <span class="text-danger">*</span></label>
                                                                                                                                                                                                                                                                        </div>
                                                                                                                                                                                                                                                                        <div class="col-sm-8">
                                                                                                                                                                                                                                                                            <div class="">
                                                                                                                                                                                                                                                                                <input id="ctrl-ac_amc_agency_contact"  value="<?php  echo $data['ac_amc_agency_contact']; ?>" type="text" placeholder="Enter Ac Amc Agency Contact"  required="" name="ac_amc_agency_contact"  class="form-control " />
                                                                                                                                                                                                                                                                                </div>
                                                                                                                                                                                                                                                                            </div>
                                                                                                                                                                                                                                                                        </div>
                                                                                                                                                                                                                                                                    </div>
                                                                                                                                                                                                                                                                    <div class="form-group ">
                                                                                                                                                                                                                                                                        <div class="row">
                                                                                                                                                                                                                                                                            <div class="col-sm-4">
                                                                                                                                                                                                                                                                                <label class="control-label" for="direction_board">DIRECTION BOARD  <span class="text-danger">*</span></label>
                                                                                                                                                                                                                                                                            </div>
                                                                                                                                                                                                                                                                            <div class="col-sm-8">
                                                                                                                                                                                                                                                                                <div class="">
                                                                                                                                                                                                                                                                                    <select required=""  id="ctrl-direction_board" name="direction_board"  placeholder="Select a value ..."    class="custom-select" >
                                                                                                                                                                                                                                                                                        <option value="">Select a value ...</option>
                                                                                                                                                                                                                                                                                        <?php
                                                                                                                                                                                                                                                                                        $direction_board_options = Menu :: $is_redevelopment;
                                                                                                                                                                                                                                                                                        $field_value = $data['direction_board'];
                                                                                                                                                                                                                                                                                        if(!empty($direction_board_options)){
                                                                                                                                                                                                                                                                                        foreach($direction_board_options as $option){
                                                                                                                                                                                                                                                                                        $value = $option['value'];
                                                                                                                                                                                                                                                                                        $label = $option['label'];
