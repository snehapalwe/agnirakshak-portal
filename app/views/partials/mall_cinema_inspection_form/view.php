...
$can_add = ACL::is_allowed("mall_cinema_inspection_form/add");
$can_edit = ACL::is_allowed("mall_cinema_inspection_form/edit");
$can_view = ACL::is_allowed("mall_cinema_inspection_form/view");
$can_delete = ACL::is_allowed("mall_cinema_inspection_form/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Mall or Cinema Hall Inspection  / मॅाल, सिनेमा गृह   पाहणी</h4>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div  class="card animated fadeIn page-content">
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-old_noc_date">
                                        ...
                                        <td class="value">
                                            <span title="<?php echo human_datetime($data['old_noc_date']); ?>" class="has-tooltip">
                                                <?php echo relative_date($data['old_noc_date']); ?>
                                            </span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr  class="td-mpcb_certificate_date">
                                        <th class="title"> Mpcb Certificate Date: </th>
                                        <td class="value"> <?php echo $data['mpcb_certificate_date']; ?></td>
                                    </tr>
                                    <tr  class="td-mpcb_certificate_validity_date">
                                        <th class="title"> Mpcb Certificate Validity Date: </th>
                                        <td class="value"> <?php echo $data['mpcb_certificate_validity_date']; ?></td>
                                    </tr>
                                    <tr  class="td-ac_amc_date">
                                        <th class="title"> Ac Amc Date: </th>
                                        <td class="value"> <?php echo $data['ac_amc_date']; ?></td>
                                    </tr>
                                    <tr  class="td-ac_amc_validity_date">
                                        <th class="title"> Ac Amc Validity Date: </th>
                                        <td class="value"> <?php echo $data['ac_amc_validity_date']; ?></td>
                                    </tr>
                                    <tr  class="td-ac_amc_agency_name">
                                        <th class="title"> Ac Amc Agency Name: </th>
                                        <td class="value"> <?php echo $data['ac_amc_agency_name']; ?></td>
                                    </tr>
                                    <tr  class="td-ac_amc_agency_address">
                                        <th class="title"> Ac Amc Agency Address: </th>
                                        <td class="value"> <?php echo $data['ac_amc_agency_address']; ?></td>
                                    </tr>
                                    <tr  class="td-ac_amc_agency_contact">
                                        <th class="title"> Ac Amc Agency Contact: </th>
                                        <td class="value"> <?php echo $data['ac_amc_agency_contact']; ?></td>
                                    </tr>
                                    <tr  class="td-direction_board">
                                        <th class="title"> Direction Board: </th>
                                        <td class="value"> <?php echo $data['direction_board']; ?></td>
                                    </tr>
                                    <tr  class="td-user_id">
                        ...
                        <div class="p-3 d-flex">
                            ...
                            <a class="btn  btn-sm btn-primary export-link-btn" data-format="excel" href="<?php print_link($export_excel_link); ?>" target="_blank">
                                ...
                                <?php if($can_edit){ ?>
                                <a class="btn btn-sm btn-info"  href="<?php print_link("mall_cinema_inspection_form/edit/$rec_id"); ?>">
                                    <i class="fa fa-edit"></i> Edit
                                </a>
                                <?php } ?>
                                <?php if($can_delete){ ?>
                                <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("mall_cinema_inspection_form/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
