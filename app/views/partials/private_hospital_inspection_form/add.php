...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><strong style='color: black;'>Private Hospital Inspection / खाजगी हॉस्पिटल पाहणी</strong></h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="private_hospital_inspection_form-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("private_hospital_inspection_form/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                                                                        ...
                                                                                        <div class="form-group ">
                                                                                            ...
                                                                                            <div class="form-group ">
                                                                                                ...
                                                                                                <div id="ctrl-is_record_room_available-holder" class=""> 
                                                                                                    <input id="ctrl-is_record_room_available"  value="<?php  echo $this->set_field_value('is_record_room_available',""); ?>" type="text" placeholder="Enter Is Record Room Available"  required="" name="is_record_room_available"  class="form-control " />
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="form-group ">
                                                                                                                                    ...
                                                                                                                                    <div class="form-group ">
                                                                                                                                        ...
                                                                                                                                        <div id="ctrl-generator_system_capacity-holder" class=""> 
                                                                                                                                            <div class="dropzone required" input="#ctrl-generator_system_capacity" fieldname="generator_system_capacity"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="3" maximum="1">
                                                                                                                                                <input name="generator_system_capacity" id="ctrl-generator_system_capacity" required="" class="dropzone-input form-control" value="<?php  echo $this->set_field_value('generator_system_capacity',""); ?>" type="text"  />
