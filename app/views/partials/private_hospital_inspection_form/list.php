...
$can_add = ACL::is_allowed("private_hospital_inspection_form/add");
$can_edit = ACL::is_allowed("private_hospital_inspection_form/edit");
$can_view = ACL::is_allowed("private_hospital_inspection_form/view");
$can_delete = ACL::is_allowed("private_hospital_inspection_form/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="grid" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Private Hospital Inspection / खाजगी हॉस्पिटल पाहणी</h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("private_hospital_inspection_form/add") ?>">
                ...
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('private_hospital_inspection_form'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('private_hospital_inspection_form'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="private_hospital_inspection_form-list-records">
                                <?php
                                if(!empty($records)){
                                ?>
                                    ...
                                    <div class="row sm-gutters page-data" id="page-data-<?php echo $page_element_id; ?>">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="bg-light p-2 mb-3 animated bounceIn">
                                                ...
                                                <div class="mb-2">  <?php Html :: page_link_file($data['generator_system_capacity']); ?></div>
                                                <div class="mb-2">  
                                                    <span class="font-weight-light text-muted ">
                                                        GENERATOR AMC ORGANIZATION :  
                                                    </span>
