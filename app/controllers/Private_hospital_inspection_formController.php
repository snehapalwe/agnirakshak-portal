<?php 
/**
 * Private_hospital_inspection_form Page Controller
 * @category  Controller
 */
class Private_hospital_inspection_formController extends SecureController{
	function __construct(){
		parent::__construct();
		$this->tablename = "private_hospital_inspection_form";
	}
	/**
     * List page records
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				private_hospital_inspection_form.id LIKE ? OR 
				private_hospital_inspection_form.recid LIKE ? OR 
				private_hospital_inspection_form.hospital_or_health_center_name LIKE ? OR 
				private_hospital_inspection_form.hospital_or_health_center_address LIKE ? OR 
				private_hospital_inspection_form.doctor_name LIKE ? OR 
				private_hospital_inspection_form.doctor_mobile_no LIKE ? OR 
				private_hospital_inspection_form.building_height LIKE ? OR 
				private_hospital_inspection_form.lifts_company_name LIKE ? OR 
				private_hospital_inspection_form.no_lifts_in_building LIKE ? OR 
				private_hospital_inspection_form.capacity_of_lifts LIKE ? OR 
				private_hospital_inspection_form.elevators_amc_done_by_org_name LIKE ? OR 
				private_hospital_inspection_form.elevators_amc_period LIKE ? OR 
				private_hospital_inspection_form.number_of_staircase_in_bulding LIKE ? OR 
				private_hospital_inspection_form.width_of_staircase_in_bulding LIKE ? OR 
				private_hospital_inspection_form.entrance_routes_count LIKE ? OR 
				private_hospital_inspection_form.exit_routes_count LIKE ? OR 
				private_hospital_inspection_form.is_record_room_available LIKE ? OR 
				private_hospital_inspection_form.hospital_area LIKE ? OR 
				private_hospital_inspection_form.doctors_count LIKE ? OR 
				private_hospital_inspection_form.nurses_count LIKE ? OR 
				private_hospital_inspection_form.ward_boy_count LIKE ? OR 
				private_hospital_inspection_form.aunts_count LIKE ? OR 
				private_hospital_inspection_form.clerk_count LIKE ? OR 
				private_hospital_inspection_form.other_employees_count LIKE ? OR 
				private_hospital_inspection_form.floor_number_of_hospital_id LIKE ? OR 
				private_hospital_inspection_form.floor_number_of_hospital_value LIKE ? OR 
				private_hospital_inspection_form.is_ot_dept LIKE ? OR 
				private_hospital_inspection_form.is_xray_dept LIKE ? OR 
				private_hospital_inspection_form.is_opd_dept LIKE ? OR 
				private_hospital_inspection_form.is_emergency_opd_dept LIKE ? OR 
				private_hospital_inspection_form.is_patholoty_dept LIKE ? OR 
				private_hospital_inspection_form.is_post_nutal_care_dept LIKE ? OR 
				private_hospital_inspection_form.is_icu_dept LIKE ? OR 
				private_hospital_inspection_form.is_gw_men_dept LIKE ? OR 
				private_hospital_inspection_form.is_gw_women_dept LIKE ? OR 
				private_hospital_inspection_form.is_special_ward_dept LIKE ? OR 
				private_hospital_inspection_form.is_ante_nutal_care_dept LIKE ? OR 
				private_hospital_inspection_form.is_nicu_dept LIKE ? OR 
				private_hospital_inspection_form.directional_board LIKE ? OR 
				private_hospital_inspection_form.total_no_beds_hospital LIKE ? OR 
				private_hospital_inspection_form.generator_system_capacity LIKE ? OR 
				private_hospital_inspection_form.generator_system_amc_org_name LIKE ? OR 
				private_hospital_inspection_form.generator_system_amc_period LIKE ? OR 
				private_hospital_inspection_form.electrical_audit_report_org_name LIKE ? OR 
				private_hospital_inspection_form.electrical_audit_report_date LIKE ? OR 
				private_hospital_inspection_form.emergency_power_system LIKE ? OR 
				private_hospital_inspection_form.info_about_fire_prevention_measures LIKE ? OR 
				private_hospital_inspection_form.mock_drill_date LIKE ? OR 
				private_hospital_inspection_form.no_emp_present_for_mock_drill LIKE ? OR 
				private_hospital_inspection_form.upload_photo_of_employee_present_for_mock_drill LIKE ? OR 
				private_hospital_inspection_form.upload_fire_marshal_names_with_mobile_no LIKE ? OR 
				private_hospital_inspection_form.water_storage_capacity_terrace LIKE ? OR 
				private_hospital_inspection_form.water_storage_capacity_groundfloor LIKE ? OR 
				private_hospital_inspection_form.fire_noc_details LIKE ? OR 
				private_hospital_inspection_form.fire_noc_date LIKE ? OR 
				private_hospital_inspection_form.other_info_about_hospital LIKE ? OR 
				private_hospital_inspection_form.oxygen_system LIKE ? OR 
				private_hospital_inspection_form.maintenance_of_emergency_routes LIKE ? OR 
				private_hospital_inspection_form.remark LIKE ? OR 
				private_hospital_inspection_form.user_id LIKE ? OR 
				private_hospital_inspection_form.date LIKE ? OR 
				private_hospital_inspection_form.status LIKE ? OR 
				private_hospital_inspection_form.paid LIKE ? OR 
				private_hospital_inspection_form.int_no LIKE ? OR 
				private_hospital_inspection_form.yr LIKE ? OR 
				private_hospital_inspection_form.zone LIKE ? OR 
				private_hospital_inspection_form.payment_done LIKE ? OR 
				private_hospital_inspection_form.certificate_file LIKE ?
			)";
			$search_params = array(
			...
			$this->view->search_template = "private_hospital_inspection_form/search.php";
		}
		if(!empty($request->orderby)){
			...
			$db->orderBy("private_hospital_inspection_form.id", ORDER_TYPE);
		}
		if($fieldname){
...
$record['mock_drill_date'] = human_datetime($record['mock_drill_date']);
$record['fire_noc_date'] = human_date($record['fire_noc_date']);
			}
		}
		$data = new stdClass;
		...
		$page_title = $this->view->page_title = "Private Hospital Inspection Form";
		$this->view->report_filename = date('Y-m-d') . '-' . $page_title;
		$this->view->report_title = $page_title;
		$this->view->report_layout = "report_layout.php";
		$this->view->report_paper_size = "A4";
		$this->view->report_orientation = "portrait";
		$this->render_view("private_hospital_inspection_form/list.php", $data); //render the full page
	}
	/**
     * View record detail 
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("private_hospital_inspection_form.id", $rec_id);; //select record based on primary key
		}
...
$record['mock_drill_date'] = human_datetime($record['mock_drill_date']);
$record['fire_noc_date'] = human_date($record['fire_noc_date']);
			$page_title = $this->view->page_title = "View  Private Hospital Inspection Form";
		$this->view->report_filename = date('Y-m-d') . '-' . $page_title;
		$this->view->report_title = $page_title;
		$this->view->report_layout = "report_layout.php";
		$this->view->report_paper_size = "A4";
		...
		return $this->render_view("private_hospital_inspection_form/view.php", $record);
	}
	/**
...
$modeldata['status'] = "0";
		...
		// Updating the inspection_done status in the `fire_noc_establishment` table.
...
$db->update("fire_noc_establishment",["inspection_done"=>$rec_id]);
		...
		$page_title = $this->view->page_title = "Add New Private Hospital Inspection Form";
		$this->render_view("private_hospital_inspection_form/add.php");
	}
	/**
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","recid","hospital_or_health_center_name","hospital_or_health_center_address","doctor_name","doctor_mobile_no","building_height","lifts_company_name","no_lifts_in_building","capacity_of_lifts","elevators_amc_done_by_org_name","elevators_amc_period","number_of_staircase_in_bulding","width_of_staircase_in_bulding","entrance_routes_count","exit_routes_count","is_record_room_available","hospital_area","doctors_count","nurses_count","ward_boy_count","aunts_count","clerk_count","other_employees_count","floor_number_of_hospital_id","is_ot_dept","is_xray_dept","is_opd_dept","is_emergency_opd_dept","is_patholoty_dept","is_post_nutal_care_dept","is_icu_dept","is_gw_men_dept","is_gw_women_dept","is_special_ward_dept","is_ante_nutal_care_dept","is_nicu_dept","directional_board","total_no_beds_hospital","generator_system_capacity","generator_system_amc_org_name","generator_system_amc_period","electrical_audit_report_org_name","electrical_audit_report_date","emergency_power_system","info_about_fire_prevention_measures","no_emp_present_for_mock_drill","upload_photo_of_employee_present_for_mock_drill","upload_fire_marshal_names_with_mobile_no","water_storage_capacity_terrace","water_storage_capacity_groundfloor","fire_noc_details","fire_noc_date","other_info_about_hospital","oxygen_system","maintenance_of_emergency_routes","remark","user_id","date","status");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'recid' => 'required',
...
$modeldata['status'] = "0";
			if($this->validated()){
				$db->where("private_hospital_inspection_form.id", $rec_id);;
				$bool = $db->update($tablename, $modeldata);
				$numRows = $db->getRowCount(); //number of affected rows. 0 = no record field updated
				if($bool && $numRows){
					$this->set_flash_msg("Record updated successfully", "success");
					return $this->redirect("private_hospital_inspection_form");
				}
				else{
					if($db->getLastError()){
						$this->set_page_error();
		...
		$page_title = $this->view->page_title = "Edit  Private Hospital Inspection Form";
		if(!$data){
			$this->set_page_error();
		}
		return $this->render_view("private_hospital_inspection_form/edit.php", $data);
	}
	/**
	...
	function delete($rec_id = null){
		...
		$db->where("private_hospital_inspection_form.id", $arr_rec_id, "in");
